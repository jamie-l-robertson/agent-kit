...
For Playwright e2e/a11y when the project uses them: follow **verify-evidence** (`.agents/skills/verify-evidence/SKILL.md`) for cold-start and blocked rules. Do not silently skip.
