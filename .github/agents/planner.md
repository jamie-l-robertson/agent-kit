...
description: >-
  ...
  to frontend/backend/ accessibility/tester/documenter/reviewer; and
  returns ordered briefs. Manager may skip you for a single obvious
  specialist. Does not implement, edit code, run tests, or write docs.
