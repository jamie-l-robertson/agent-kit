...
name: accessibility
description: >-
  Accessibility owner for WCAG audits and surgical remediation: keyboard
  access, focus order/traps, ARIA, labels, contrast, screen-reader
  semantics, reduced-motion, and axe/a11y test failures. Use for a11y,
  WCAG, screen reader, focus management, contrast. Not for visual redesign
  (frontend), harness/CI wiring (tester), or API/CMS work (backend).
---
