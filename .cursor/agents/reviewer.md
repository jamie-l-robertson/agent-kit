...
description: >-
  ...
  Loads code-review skill (lint Evidence + available logs + judgment). Does not
  implement — routes via Recommend next (frontend/backend/tester/security/risk/
  devops/infrastructure). Not for writing features or docs.
readonly: true
model: inherit
---
